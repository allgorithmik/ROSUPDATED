...
bool my_interface_pkg__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interface_pkg.msg._hardware_status.HardwareStatus", full_classname_dest, 52) == 0);
  }
  my_interface_pkg__msg__HardwareStatus * ros_message = _ros_message;
  {  // temperature
...
PyObject * my_interface_pkg__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interface_pkg.msg._hardware_status");
