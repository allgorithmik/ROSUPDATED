...
{
  new (message_memory) my_interface_pkg::msg::HardwareStatus(_init);
}

void HardwareStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_interface_pkg::msg::HardwareStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HardwareStatus_message_member_array[3] = {
  {
    ...
    offsetof(my_interface_pkg::msg::HardwareStatus, temperature),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_interface_pkg::msg::HardwareStatus, are_motors_ready),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_interface_pkg::msg::HardwareStatus, debug_message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HardwareStatus_message_members = {
  "my_interface_pkg::msg",  // message namespace
  "HardwareStatus",  // message name
  3,  // number of fields
  sizeof(my_interface_pkg::msg::HardwareStatus),
...
get_message_type_support_handle<my_interface_pkg::msg::HardwareStatus>()
{
  return &::my_interface_pkg::msg::rosidl_typesupport_introspection_cpp::HardwareStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interface_pkg, msg, HardwareStatus)() {
  return &::my_interface_pkg::msg::rosidl_typesupport_introspection_cpp::HardwareStatus_message_type_support_handle;
}
