...
class Metaclass_ComputeRectangleArea_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('my_interface_pkg')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ComputeRectangleArea(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_interface_pkg.srv.ComputeRectangleArea')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_interface_pkg.srv import _compute_rectangle_area
...
class ComputeRectangleArea(metaclass=Metaclass_ComputeRectangleArea):
    from my_interface_pkg.srv._compute_rectangle_area import ComputeRectangleArea_Request as Request
    from my_interface_pkg.srv._compute_rectangle_area import ComputeRectangleArea_Response as Response
