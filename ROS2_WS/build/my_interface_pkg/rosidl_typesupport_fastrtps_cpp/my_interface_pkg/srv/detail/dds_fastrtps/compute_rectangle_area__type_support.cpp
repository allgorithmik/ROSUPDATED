...
#include "my_interface_pkg/srv/detail/compute_rectangle_area__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_interface_pkg::srv::ComputeRectangleArea_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interface_pkg::srv::ComputeRectangleArea_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_my_interface_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<my_interface_pkg::srv::ComputeRectangleArea_Request>()
{
  return &my_interface_pkg::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const my_interface_pkg::srv::ComputeRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_interface_pkg::srv::ComputeRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_interface_pkg::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Response__handle;
}
...
{
  return &my_interface_pkg::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea__handle;
}
