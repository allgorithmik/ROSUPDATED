...
#include "my_interface_pkg/msg/detail/hardware_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interface_pkg::msg::HardwareStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interface_pkg::msg::HardwareStatus & ros_message)
{
  // Member: temperature
  cdr >> ros_message.temperature;
...
{
  auto typed_message =
    static_cast<const my_interface_pkg::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interface_pkg::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  return &my_interface_pkg::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interface_pkg, msg, HardwareStatus)() {
  return &my_interface_pkg::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
