...
#include "my_interface_pkg/msg/detail/hardware_status__rosidl_typesupport_fastrtps_c.h"
...
using _HardwareStatus__ros_msg_type = my_interface_pkg__msg__HardwareStatus;
...
size_t get_serialized_size_my_interface_pkg__msg__HardwareStatus(
  const void * untyped_ros_message,
...
static uint32_t _HardwareStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interface_pkg__msg__HardwareStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interface_pkg
size_t max_serialized_size_my_interface_pkg__msg__HardwareStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_my_interface_pkg__msg__HardwareStatus(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_HardwareStatus = {
  "my_interface_pkg::msg",
  "HardwareStatus",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interface_pkg, msg, HardwareStatus)() {
