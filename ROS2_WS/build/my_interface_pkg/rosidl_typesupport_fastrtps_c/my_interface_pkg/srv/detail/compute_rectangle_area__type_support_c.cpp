...
#include "my_interface_pkg/srv/detail/compute_rectangle_area__rosidl_typesupport_fastrtps_c.h"
...
#include "my_interface_pkg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ComputeRectangleArea_Request__ros_msg_type = my_interface_pkg__srv__ComputeRectangleArea_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interface_pkg
size_t get_serialized_size_my_interface_pkg__srv__ComputeRectangleArea_Request(
  const void * untyped_ros_message,
...
static uint32_t _ComputeRectangleArea_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interface_pkg__srv__ComputeRectangleArea_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interface_pkg
size_t max_serialized_size_my_interface_pkg__srv__ComputeRectangleArea_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_my_interface_pkg__srv__ComputeRectangleArea_Request(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ComputeRectangleArea_Request = {
  "my_interface_pkg::srv",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interface_pkg, srv, ComputeRectangleArea_Request)() {
...
using _ComputeRectangleArea_Response__ros_msg_type = my_interface_pkg__srv__ComputeRectangleArea_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interface_pkg
size_t get_serialized_size_my_interface_pkg__srv__ComputeRectangleArea_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ComputeRectangleArea_Response__ros_msg_type * ros_message = static_cast<const _ComputeRectangleArea_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interface_pkg__srv__ComputeRectangleArea_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interface_pkg
size_t max_serialized_size_my_interface_pkg__srv__ComputeRectangleArea_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_my_interface_pkg__srv__ComputeRectangleArea_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interface_pkg, srv, ComputeRectangleArea_Response)() {
...
// already included above
// #include "my_interface_pkg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_interface_pkg/srv/compute_rectangle_area.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interface_pkg, srv, ComputeRectangleArea)() {
