...
static const _HardwareStatus_type_support_symbol_names_t _HardwareStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interface_pkg, msg, HardwareStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_interface_pkg, msg, HardwareStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_interface_pkg, msg, HardwareStatus)() {
  return &::my_interface_pkg::msg::rosidl_typesupport_c::HardwareStatus_message_type_support_handle;
}
